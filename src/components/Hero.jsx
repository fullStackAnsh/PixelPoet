...
function Hero() {
  ...
  return (
    ...
    <div className='absolute lg:text-[3rem] text-white z-10 font-hero  font-extrabold text-lg tracking-[0.2rem] top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]'>Divyanshu Kumar</div>
